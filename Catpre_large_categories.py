...
writer = csv.writer(f)
title = ["브랜드명", "상품명", "현재가격", "할인전가격", "리뷰수", "별점", "재고상태", "배송유형", "배송비용"]
writer.writerow(title)

categories = ["053"]
#"054","055","056","057","058","059","060","061","063","064","069","065","070"]
...
for category in categories:
    ...
    while True:
        ...
        for item in content_product:
            ...
            price_before_discount_per_item = price_before_discount_per_item + irregular
            ...
            if price_before_discount_per_item == []:
                print(page_index)
                print(row_num)
                raise Exception("NA Pre-Dicsount Price")
